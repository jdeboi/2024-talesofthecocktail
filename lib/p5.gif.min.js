!(function (e, t) {
  ...
  var e = function (e) {
    ...
    a = function (n, a) {
      ...
      var i = function (e) {
        ...
        o = function () {
          var e, t;
          t = "";
          do (e = n.readByte()), (t += n.read(e));
          while (0 !== e);
          return t;
        },
        u = function () {
          var r = {};
          if (((r.sig = n.read(3)), (r.ver = n.read(3)), "GIF" !== r.sig))
            throw new Error("Not a GIF file.");
          (r.width = n.readUnsigned()), (r.height = n.readUnsigned());
          var o = t(n.readByte());
          (r.gctFlag = o.shift()),
            (r.colorRes = e(o.splice(0, 3))),
            (r.sorted = o.shift()),
            (r.gctSize = e(o.splice(0, 3))),
            (r.bgColor = n.readByte()),
            (r.pixelAspectRatio = n.readByte()),
            r.gctFlag && (r.gct = i(1 << (r.gctSize + 1))),
            a.hdr && a.hdr(r);
        },
        l = function (r) {
          var i = function (r) {
              var i = (n.readByte(), t(n.readByte()));
              (r.reserved = i.splice(0, 3)),
                (r.disposalMethod = e(i.splice(0, 3))),
                (r.userInput = i.shift()),
                (r.transparencyGiven = i.shift()),
                (r.delayTime = n.readUnsigned()),
                (r.transparencyIndex = n.readByte()),
                (r.terminator = n.readByte()),
                a.gce && a.gce(r);
            },
            u = function (e) {
            ...
            f = function (e) {
              var t = function (e) {
                ...
                r = function (e) {
                  (e.appData = o()),
                    a.app && a.app[e.identifier] && a.app[e.identifier](e);
                };
              n.readByte();
              switch (
        ...
        f = function (u) {
          ...
          (u.leftPos = n.readUnsigned()),
            (u.topPos = n.readUnsigned()),
            (u.width = n.readUnsigned()),
            (u.height = n.readUnsigned());
          var f = t(n.readByte());
          (u.lctFlag = f.shift()),
            (u.interlaced = f.shift()),
            (u.sorted = f.shift()),
            (u.reserved = f.splice(0, 2)),
            (u.lctSize = e(f.splice(0, 3))),
            u.lctFlag && (u.lct = i(1 << (u.lctSize + 1))),
            (u.lzwMinCodeSize = n.readByte());
          var c = o();
          (u.pixels = r(u.lzwMinCodeSize, c)),
            u.interlaced && (u.pixels = l(u.pixels, u.width)),
            a.img && a.img(u);
        },
        c = function () {
          var e = {};
          switch (
            ((e.sentinel = n.readByte()), String.fromCharCode(e.sentinel))
          ) {
            case "!":
              (e.type = "ext"), l(e);
              break;
    ...
    i = function (e) {
      ...
      var B,
        b,
        T = t.hasOwnProperty("on_end") ? t.on_end : null,
        ...
        I = function (e, t) {
          return w[e]
            ? ("undefined" != typeof t.x && (w[e].x = t.x),
              void ("undefined" != typeof t.y && (w[e].y = t.y)))
            : void (w[e] = t);
        },
        U = function (e) {
          (u = e), (_ = []);
        ...
        G = function (e) {
          z(),
            C(),
            (f = e.transparencyGiven ? e.transparencyIndex : null),
            (c = e.delayTime),
            (s = e.disposalMethod);
        },
        z = function () {
        ...
        F = function (e) {
          ...
          t > 0 &&
            (3 === p
              ? null !== d
                ? h.putImageData(_[d].data, 0, 0)
                : h.clearRect(g.leftPos, g.topPos, g.width, g.height)
              : (d = t - 1),
            2 === p && h.clearRect(g.leftPos, g.topPos, g.width, g.height));
          ...
          e.pixels.forEach(function (e, t) {
            ...
            r.data.set(a),
            h.putImageData(r, e.leftPos, e.topPos),
            m || (m = !0),
            (g = e);
        },
        D = (function () {
          var e = -1,
              ...
              var t = !1,
                o = function () {
                  if ((t = y)) {
                    ...
                    u || (u = 100);
                    var l = r();
                    0 === l && ((u += P), setTimeout(i, u - 1)),
                      (k !== !1 || 0 !== l || 0 > n) && setTimeout(o, u);
                  }
                };
              return function () {
                t || setTimeout(o, 0);
            ...
            l = function () {
              ...
              (e = parseInt(e, 10)),
                ...
                0 > e && (e = 0),
                (t = w[e]),
                B.getContext("2d").putImageData(_[e].data, t.x, t.y);
            },
            f = function () {
              (y = !0), o();
            },
        ...
        H = function () {
          var e;
          return (e =
            t.max_width && o && o.width > t.max_width
              ? t.max_width / o.width
              : 1);
        },
        L = !1,
  ...
  (function () {
    (p5.prototype.loadGif = function (e, t) {
      var n = new SuperGif({ gif: e, p5inst: this });
      n.load(t);
      var r = n.buffer();
      return (
        (r.play = n.play),
        (r.pause = n.pause),
        (r.playing = n.get_playing),
        (r.frames = n.get_frames),
        (r.totalFrames = n.get_length),
        (r.loaded = function () {
      ...
      (p5.prototype.loadRawGif = function (e, t) {
        var n = new SuperGif({ gif: "", p5inst: this });
        n.load_raw(e, t);
        var r = n.buffer();
        return (
          (r.play = n.play),
