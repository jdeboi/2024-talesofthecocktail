(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["p5.mapper"] = factory(require("p5"));
	else
		root["p5.mapper"] = factory(root["p5"]);
})(self, function(__WEBPACK_EXTERNAL_MODULE__700__) {
...
var Draggable_1 = __importDefault(__webpack_require__(318));
var MovePoint_1 = __importDefault(__webpack_require__(506));
var p5_1 = __importDefault(__webpack_require__(700));
...
// EXTERNAL MODULE: ./src/surfaces/MovePoint.js
var MovePoint = __webpack_require__(506);
...
// EXTERNAL MODULE: ./src/surfaces/Draggable.js
...
var Surface = /*#__PURE__*/function (_Draggable) {
  ...
  return Surface;
}(Draggable["default"]); // TRYING OUT A NEW METHOD OF DISPLAYING TEXTURE
...
var QuadMap = /*#__PURE__*/function (_CornerPinSurface) {
  ...
  function QuadMap(id, w, h, res, buffer, pInst) {
    ...
    _this = _super.call(this, id, w, h, res, "QUAD", buffer, pInst);
  ...
  QuadMap_createClass(QuadMap, [{
    ...
    value: function calculateMesh() {
      ...
      this.perspT = perspective_PerspT(srcCorners, dstCorners);
...
var PolyMap = /*#__PURE__*/function (_Surface) {
  ...
  function PolyMap(id, numPoints, buffer, pInst) {
    ...
    for (var i = 0; i < numPoints; i++) {
      ...
      var cp = new MovePoint["default"](PolyMap_assertThisInitialized(_this), x, y, _this.pInst);
  ...
  PolyMap_createClass(PolyMap, [{
    ...
    value: function setPoints(pts) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var p = _step.value;
          var cp = new MovePoint["default"](this, p.x, p.y, this.pInst);
          cp.isControlPoint = true;
          this.points.push(cp);
        }
      } catch (err) {
...
// EXTERNAL MODULE: ./src/lines/LineMap.js
var LineMap = __webpack_require__(485);
var LineMap_default = /*#__PURE__*/__webpack_require__.n(LineMap);
...
var ProjectionMapper = /*#__PURE__*/function () {
  ...
  ProjectionMapper_createClass(ProjectionMapper, [{
    ...
    value: function createLineMap() {
      ...
      var l = new (LineMap_default())(x0, y0, x1, y1, this.lines.length, this.pInst);
      this.lines.push(l);
      return l;
    }
  }, {
